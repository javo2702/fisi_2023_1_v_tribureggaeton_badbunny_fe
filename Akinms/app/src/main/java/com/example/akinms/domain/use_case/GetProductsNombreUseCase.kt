...
class GetProductsNombreUseCase @Inject constructor(
    private val respository: ProductRepository
) {
    operator fun invoke(id: Long, valor: String): Flow<Result<List<Products>>>{
        return respository.getProductsNombre(id,valor)
    }
}